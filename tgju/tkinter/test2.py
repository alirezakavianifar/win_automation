...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.button_1 = customtkinter.CTkButton(master=self.frame_left,
                                                text="دریافت اطلاعات tgju",
                                                command=lambda: thread_tgju_start())
        ...
        self.check_box_4 = customtkinter.CTkCheckBox(master=self.frame_right,
                                                     text="CTkCheckBox")
        self.check_box_4.grid(row=7, column=0, pady=10, padx=20, sticky="w")
